...
import 'package:crud_app/widgets/snackbar_message.dart';
...
class _AddNewProductState extends State<AddNewProduct> {
  bool __addProductInprogress = false;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  visible: __addProductInprogress == false,
  ...
  Future<void> _onTapAddProductButton() async {
    ...
    __addProductInprogress = true;
    setState(() {});
    // preapare rul to request
